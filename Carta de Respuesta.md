...
- La sensibilidad incluyó cuatro especificaciones: llave exacta y tolerancias de 1, 2 y 3 semanas. La llave exacta consolidó 139 registros y produjo 7.048 eventos obstétricos finales; la tolerancia de una semana consolidó 140 registros y produjo 7.047 eventos; la de dos semanas consolidó 146 registros y produjo 7.041 eventos; y la regla principal de tres semanas consolidó 152 registros y produjo 7.035 eventos finales. Los eventos clasificados como embarazos múltiples fueron 258, 257, 251 y 245, respectivamente. Por tanto, la muestra principal de 7.035 eventos corresponde específicamente a la regla de tres semanas. Los resultados reproducibles se encuentran en `output/reconciliation/sensibilidad_linkage_CORREGIDA.csv`.
- El procedimiento redujo el sobreconteo atribuible a registros múltiples y produjo una muestra consistente con la unidad de análisis definida; no obstante, debido a la ausencia de un identificador único y al carácter determinístico del linkage, no puede excluirse completamente clasificación residual.
