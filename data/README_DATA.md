...
- Registro de datos: [Mendeley Data, “Embarazo adolescente”, versión 2](https://doi.org/10.17632/jbbp5vb6fy.2).
- El archivo no se duplica en Git ni en Zenodo. Antes de obtenerlo o reutilizarlo, consulte en Mendeley Data las condiciones vigentes y las autorizaciones institucionales aplicables.
- Para una reproducción autorizada, guarde el archivo en la raíz como `Adolescentes.csv`.
