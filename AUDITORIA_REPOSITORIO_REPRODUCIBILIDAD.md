...
> Actualización R2 (2026-08-23): las fuentes vigentes de las Figuras 1 y 3 ya fueron incorporadas como `Figura1_marco_seleccion_EN.R` y `Figura3_distribucion_anual_EN.R`. Las filas históricas correspondientes se actualizan a continuación.
...
| `Figura1_marco_seleccion_EN.R` | Fuente vigente para Figura 1 | Sí | Disponible y regenerada | Conservar junto con `image1.png` |
| `Figura3_distribucion_anual_EN.R` | Fuente vigente para Figura 3 | Sí | Disponible y regenerada | Conservar junto con `image3.jpeg` |
...
| `manuscript/media/media/image1.png` | Figura 1 incorporada | Sí | Disponible con script fuente vigente | Regenerable |
| `manuscript/media/media/image2.png` | Figura 2 incorporada | Sí | Disponible con script fuente | Regenerable |
| `manuscript/media/media/image3.jpeg` | Figura 3 incorporada | Sí | Disponible con script fuente vigente | Regenerable |
