...
## Advertencias y archivos faltantes
...
**REPRODUCIBLE_CON_ADVERTENCIAS**: el flujo determinista, la trazabilidad tabular, el entorno y el orquestador están documentados y validados; quedan pendientes una corrida Stan completa desde entorno limpio, la comprobación exacta de la base externa y la recuperación de los scripts R2 de las Figuras 1 y 3.
