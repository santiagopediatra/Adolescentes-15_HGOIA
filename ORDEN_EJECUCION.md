...
| 10 | `Figura1_marco_seleccion_EN.R` | Ninguna; diagrama conceptual | `manuscript/media/media/image1.png` |
| 11 | `Figura2_flujograma_STROBE.R` | Ninguna; usa conteos codificados que deben cotejarse | `manuscript/media/media/image2.png` |
| 12 | `Figura3_distribucion_anual_EN.R` | Ninguna; usa conteos anuales codificados que deben cotejarse | `manuscript/media/media/image3.jpeg` |
| 13 | Render del manuscrito vigente | Fuente del manuscrito, CSL, bibliografía y figuras | DOCX; las tablas deben cotejarse con S1–S10 |
