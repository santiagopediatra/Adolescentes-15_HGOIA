...
|---|---|---|---|---|
| `manuscript/Adolescentes_19_julio.qmd`, disponibilidad de datos | Registro de datos en Mendeley Data | `https://doi.org/10.17632/jbbp5vb6fy.2` | Actualizado en R2; el texto remite a las condiciones vigentes del depósito | Verificar las condiciones externas antes del envío |
| DOCX limpio, disponibilidad de datos | Igual que QMD | Versión incorporada durante la entrega editorial | Debe cotejarse con el QMD R2 antes del envío | Actualizar al renderizar la versión final |
